...
<div class="clearfix"></div>
  ...
  <div class="row">
      <div class="col-md-12">
        <h3><center><b>INGRESAR NUEVA SUCURSAL</b></center></h3>
        <center><img src="<?php echo base_url('assets/imgFedex/icon_sucursales.png'); ?>" alt=""></center>
        <form  class="" id="frm_nuevo_sucursal" action="<?php echo site_url(); ?>/sucursales/guardar" method="post">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" required placeholder="Ingrese el nombre" class="form-control" name="nombre_suc" value="" id="nombre_suc">
            </div>
            <div class="col-md-4">
                <label for="">Direccion:
                  <span class="obligatorio">(Obligatorio)</span>
                </label>
                <input type="text" required placeholder="Ingrese la dirección" class="form-control" name="direccion_suc" value="" id="direccion_suc">
            </div>
            <div class="col-md-4">
                <label for="">Ciudad:
                  <span class="obligatorio">(Obligatorio)</span>
                </label>
                <input type="text" required placeholder="Ingrese la ciudad" class="form-control" name="ciudad_suc" value="" id="ciudad_suc">
            </div>
        </div> <!-- </div> FIN ROW 1 -->
        ...
        <div class="row">
            <div class="col-md-4">
              ...
              <br>
              <select type="text" required id="id_con" name="id_con" class="form-control">
                <option disabled selected hidden value="">Seleccione el Continente:</option>
                <?php foreach ($continentes as $valores){ ?>
                    <option  value="<?php echo $valores->id_con;?>"><?php echo $valores->nombre_con;?> </option>
                <?php } ?>
              </select>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" required placeholder="Ingrese el Nro. telefónico" class="form-control" name="telefono_suc" value="" id="telefono_suc">
            </div>
        </div> <!-- FIN ROW 2 -->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="float" required placeholder="Ingrese la latitud" class="form-control" readonly name="latitud_suc" value="" id="latitud_suc">
            </div>
            <div class="col-md-6">
                <label for="">Longitud:
                  <span class="obligatorio">(Obligatorio)</span>
                </label>
                <input type="float" required placeholder="Ingrese la longitud" class="form-control" readonly name="longitud_suc" value="" id="longitud_suc">
            </div>
        </div> <!-- FIN ROW 3 -->
        <div class="row">
            <div class="col-md-12">
                <!-- <label for="">FEDEX MATRIZ:</label> -->
                <input type="hidden" required placeholder="Ingrese matriz" class="form-control"  name="id_fed" value="fed001" readonly id="id_fed">
            </div>
        </div> <!-- FIN ROW 3 -->
