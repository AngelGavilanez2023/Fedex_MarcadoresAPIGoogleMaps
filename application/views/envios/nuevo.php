  ...
  <div class="content-wrapper">
    ...
    <div class="row ">
      <div class="container">
        ...
        <div class="col-md-12 text-center">
          <h3><center><b>INGRESAR NUEVO ENVIO</b></center></h3>
      ...
      <div class="container">
        <form class="" id="frm_nuevo_pedido" action="<?php echo site_url(); ?>/Envios/guardar" method="post">
          <div class="row">
            <div class="col-md-2">
              <label for="">ID</label>
              <!-- <input type="hidden" placeholder="Ingrese matriz" class="form-control"  name="id_cli" value="$valor" readonly id="id_cli"> -->
              <br>
              <input type="Text" readonly class="form-control" name="id_cli" id="id_cli" value="<?php echo $cliente->id_cli;?>">
            </div>
            <div class="col-md-2">
              <label for="">CLIENTE</label>
              <br>
              <input type="Text" readonly class="form-control" name="nombres_cli" id="nombres_cli" value="<?php echo $cliente->nombres_cli;?>">
            </div>
            <div class="col-md-4">
              <label for="">Fecha de envio:
                <span class="obligatorio">(Obligatorio)</span>
              </label>
              <input type="date" required  class="form-control" name="fecha_envio_env" value="" id="fecha_envio_env">
            </div>
            <div class="col-md-4">
              <label for="">Fecha de entrega:
                <span class="obligatorio">(Obligatorio)</span>
              </label>
              <input type="date"  required class="form-control" name="fecha_entrega_env" value="" id="fecha_entrega_env">
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-md-3">
              ...
              <br>
              <select type="hidden" required id="id_est" name="id_est" class="form-control">
            ...
            <div class="col-md-3">
              ...
              <br>
              <input type="number" step="0.01" required placeholder="Ingrese el peso del paquete en Kg" class="form-control" name="peso_env" id="peso_env" value="" >
            </div>
            <div class="col-md-3">
              ...
              <br>
            <input type="number" step="0.01" required placeholder="Ingrese el costo del paquete" class="form-control" name="costo_env" id="costo_env" value="" >
            </div>
            <div class="col-md-3">
              ...
              <br>
              <input type="text" required placeholder="Ingrese el detalle del paquete" class="form-control" name="detalle_env" id="detalle_env" value="" >
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-md-6">
              ...
              <select type="text" required id="id_suc" name="id_suc" class="form-control">
                <option disabled selected hidden value="">Seleccione la Sucursal Origen</option>
            ...
            <div class="col-md-6">
              ...
              <select type="text" required id="destino_env" name="destino_env" class="form-control">
                <option disabled selected hidden value="">Seleccione la Sucursal Destino</option>
                <?php foreach ($sucursales as $valores){ ?>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <br>
              <input type="text" placeholder="Seleccione en el mapa" class="form-control" readonly  required name="latitud_env" id="latitud_env" value="" >
            </div>
            <div class="col-md-6">
              <label for="">Longitud:
                <span class="obligatorio">(Obligatorio)</span>
              ...
              <br>
              <input type="text" placeholder="Seleccione en el mapa" class="form-control" readonly required  name="longitud_env" id="longitud_env" value="" >
            </div>
          </div>
          <br>
          <div class="row">
    ...
    selectSucursal.addEventListener('change', function() {
      ...
      <script type="text/javascript">
        ...
        function initMap(){
          //Definir y crear coordenada Central
          var centro=new google.maps.LatLng(0.0000, -48.47662);
          //Mapa 3
          //Crear Objeto mapa
