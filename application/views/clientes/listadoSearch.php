<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
   ...
   <?php if ($results): ?>
           ...
           <tbody>
               <?php foreach ($results as $filaTemporal): ?>
                   <tr>
                       <td>
                       ...
                       <td class="text-center">
                           ...
                           <a href="<?php echo site_url(); ?>/Pedidos/nuevo/?idCliente=<?php echo $idCliente;?>&nom=<?php echo $nombre;?>"
                             title="Eliminar Sucursal" style="color:purple;"
