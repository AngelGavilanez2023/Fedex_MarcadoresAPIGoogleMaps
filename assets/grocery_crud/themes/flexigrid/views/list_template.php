...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv"  style="padding-bottom:10px !important; background:none !important; border:none;" >
		<?php if(!$unset_add){?>
		<div class="tDiv2">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>'
						class='add_button btn btn-primary btn-lg'>
									&nbsp; &nbsp; <b><i class="fa fa-plus-circle"> </i>  <?php echo $this->l('list_add'); ?> <?php echo $subject?></b> &nbsp; &nbsp;
           </a>
		...
		<div class="tDiv3">
			<?php if(!$unset_export) { ?>
        	<a class="export-anchor btn btn-secondary" href="<?php echo $export_url; ?>" download style="color:white;">
						<i class="fa fa-file-excel"></i>
						<span class="export"><?php echo $this->l('list_export');?> a Excel</span>
            </a>
			<!-- <div class="btnseparator"></div> -->
			<?php } ?>
			<?php if(!$unset_print) { ?>
        	<a class="print-anchor btn btn-secondary" data-url="<?php echo $print_url; ?>" style="color:white;">

						<i class="fa fa-print"></i>

						<span class="print"><?php echo $this->l('list_print');?> Reporte</span>
